...
[DKMS](https://manpages.ubuntu.com/manpages/noble/en/man8/dkms.8.html) instead.
```
...
- You need the patch you intend to apply.
...
as shown above, then retry from `make O=../build_module outputmakefile`.
```
